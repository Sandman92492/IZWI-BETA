...
def create_alert(community_id, user_id, category, description, latitude=0.0, longitude=0.0, is_verified=False):
    """Create a new alert"""
    # Validate input
...
def create_verified_alert(community_id, user_id, category, description, latitude=0.0, longitude=0.0):
    """Create a verified alert shortcut"""
    return create_alert(community_id, user_id, category, description, latitude, longitude, is_verified=True)
